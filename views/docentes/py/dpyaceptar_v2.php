...
<div class="container-fluid mb-4">
    ...
    <h1 class="h3 mb-0 text-primary">Proyecto <i class="fas fa-chevron-right fa-xs"></i> Aprobación </h1>
    <br>
    ...
    <h1 class="h6 mb-0 text-gray-800 ">
      ...
      <span class="font-weight-bold">Tesista[R]:</span> <?php echo($nombre) ?> <br>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
                    ...
                    <div class="row h-100 m-4">
                        ...
                        <i class="fas fa-check fa-5x text-success"></i>
                         ...
                         <div class="col-sm-8 align-self-center text-justify text-interWin" id="divAccion">
                            La aprobación de este proyecto de tesis implica que, el mencionado, cumple con los líneamientos de investigación requeridos por el programa de Posgrado con los cuales usted se encuentra de acuerdo.
                         </div>
      ...
      <div class="modal-footer mr-4">
        ...
        <a onclick="saveNclose('operacion/aceptar/<?php echo($idtram) ?>/0','mdAceptar','divAccion','viewListaProyecto')" href="javascript:void(0)"  type="button" class="btn btn-success"> Aprobar </a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
                    ...
                    <div class="row h-100 m-4">
                        ...
                        <i class="fas fa-ban fa-5x text-cancel"></i>
                         ...
                         Registre los motivos por el cual esta desaprobando el proyecto
      ...
      <div class="modal-footer mr-4">
        <button type="button" class="btn btn-link text-gray-500"  data-dismiss="modal"> Cancelar </button>
        <a onclick="saveNclose('operacion/rechazar/<?php echo($idtram) ?>','mdRechazar','divAccion','viewListaProyecto')" href="javascript:void(0)"  type="button" class="btn btn-success"> Rechazar </a>
      </div>
    </div>
  </div>
</div>
