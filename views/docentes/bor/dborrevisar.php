...
<div class="container-fluid mb-4">
    ...
    <h1 class="h3 mb-0 text-primary">Borrador<i class="fas fa-chevron-right fa-xs"></i> Revisión </h1>
    <br>
    ...
    <i class="fas fa-calendar-alt"></i> Asignación : </span> <?php echo($fecha_asignacion) ?> <span class="badge badge-dark"> <i class="fas fa-stopwatch"></i> Días restantes para revisión :</span> 10 días hábiles 
    <br>
    <br>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
                    ...
                    <div class="row h-100 m-4">
                        ...
                        <i class="fas fa-check fa-5x text-success"></i>
                         ...
                         <div class="col-sm-8 align-self-center text-justify text-interWin" id="divAccion">
                            Esta a punto de finalizar el proceso de correción de borrador de tesis. Luego de finalizada usted no podrá agregar más correcciones.
                         </div>
      ...
      <div class="modal-footer mr-4">
        ...
        <a onclick="saveNclose('finCorreccionBor/<?php echo($idtram)?>/<?php echo($rol)?>','mdAceptar','divAccion','viewListaBorrador')" href="javascript:void(0)"  type="button" class="btn btn-success"> Aceptar </a>
      </div>
    </div>
  </div>
</div>
