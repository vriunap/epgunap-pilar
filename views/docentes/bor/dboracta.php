...
<div class="container-fluid mb-4">
    ...
    <h1 class="h3 mb-0 text-primary">Borrador <i class="fas fa-chevron-right fa-xs"></i> Acta de aprobación de reunión de dictámen </h1>
    <br>
...
<div class="card  mb-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 mb-4">
                    ...
                    <embed src= "<?php echo (base_url("tesistas/actaBorr/").$idtram) ?>" width="100%" height="800">

                </div>
                <div class="col-lg-3 mb-4">
                
                        <a href="<?php echo (base_url("tesistas/actaBorr/").$idtram) ?>" download class="btn d-block btn-primary btn-icon-split">
