...
<div class="container-fluid mb-4">
    ...
    <h1 class="h3 mb-0 text-primary">Borrador <i class="fas fa-chevron-right fa-xs"></i> Dictaminación </h1>
    <br>
...
<div class="card  mb-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-4">
                        ...
                        <br>
                            <label>Correcciones realizadas previamente en la etapa de revisión de borrador de tesis</label>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
                    ...
                    <div class="row h-100 m-4">
                        ...
                        <i class="fas fa-check fa-5x text-success"></i>
                         ...
                         <div class="col-sm-8 align-self-center text-justify text-interWin" id="divAccion">
                            Esta a punto de finalizar el proceso de dictaminación de borrador de tesis aprobándolo sin ninguna observación.
                         </div>
      ...
      <div class="modal-footer mr-4">
        ...
        <a onclick="saveNclose('finDictaminacionBor/<?php echo($idtram)?>/<?php echo($rol)?>/1','mdDictaminar1','divAccion','viewListaBorrador')" href="javascript:void(0)"  type="button" class="btn btn-success"> Aceptar </a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="mdDictaminar2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
                    ...
                    <div class="row h-100 m-4">
                        ...
                        <i class="fas fa-check fa-5x text-success"></i>
                         ...
                         <div class="col-sm-8 align-self-center text-justify text-interWin" id="divAccion">
                            Registre las observaciones al borrador antes de su aprobación
      ...
      <div class="modal-footer mr-4">
        <button type="button" class="btn btn-link text-gray-500"  data-dismiss="modal"> Cancelar </button>
        <a onclick="saveNclose('finDictaminacionBor/<?php echo($idtram)?>/<?php echo($rol)?>/2','mdDictaminar2','divAccion','viewListaBorrador')" href="javascript:void(0)"  type="button" class="btn btn-success"> Aceptar </a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="mdDictaminar3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
                    ...
                    <div class="row h-100 m-4">
                        ...
                        <i class="fas fa-ban fa-5x text-cancel"></i>
                         ...
                         <div class="col-sm-8 align-self-center text-justify text-interWin" id="divAccion">
                            Esta a punto de desaprobar este borrador de tesis.
                         </div>
      ...
      <div class="modal-footer mr-4">
        <button type="button" class="btn btn-link text-gray-500"  data-dismiss="modal"> Cancelar </button>
        <a onclick="saveNclose('finDictaminacionBor/<?php echo($idtram)?>/<?php echo($rol)?>/-1','mdDictaminar3','divAccion','viewListaBorrador')" href="javascript:void(0)"  type="button" class="btn btn-success"> Aceptar </a>
      </div>
    </div>
  </div>
</div>
