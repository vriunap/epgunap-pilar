    ...
    <div class="alert alert-info">
        ...
        <b>PROYECTO EN REVISIÓN POR LOS JURADOS DE TESIS</b><br> debe de comunicarse con los jurados de tesis para la respectiva revisión. <small>(Tiempo Estimado : 15 Días)</small>
    </div>
...
<div class="card card-timeline mb-4" id="contentPytoKind">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <!-- <button class="float-right btn btn-primary" onclick="loadForm('IdUpload','msgPanel/warning/Cargando...')"> Subir Correcciones</button> -->
            <button class="float-right btn btn-primary" onclick="loadForm('contentPytoKind','viewCorrecs/2020')"> Subir Correcciones</button>
        </div>
