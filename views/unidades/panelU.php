...
<head>
  ...
  <title>Pilar EPG - Unidades</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-darkblue  sidebar sidebar-dark accordion  bg-purple" id="accordionSidebar">
      <br>
      <!-- Sidebar - Brand -->
...
UNIDAD EPG PILAR 2020
        ...
        <div class="container-fluid" id='ctntFlow'>
          ...
          <div class="row">
             ...
             <?php 
              $countp=$this->dbPilar->getSnapView('tesTramites',"Tipo=1 AND IdFacultad=$sess->IdFacultad")->num_rows();
              $countb=$this->dbPilar->getSnapView('tesTramites',"Tipo=2 AND IdFacultad=$sess->IdFacultad")->num_rows();
              $countr=$this->dbPilar->getSnapView('tesTramites',"Tipo=0 AND IdFacultad=$sess->IdFacultad")->num_rows();
            ?>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Rechazados</div>
