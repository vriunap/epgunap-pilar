                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5 ">
                                <div class="card-header"><h3 class="text-center font-weight-bold text-dark my-4">Administración</h3></div>
                                <div class="card-body" id='dtaLogin'>

                                    <form  method="POST" name='frmLogin' id='frmLogin' action="<?php echo base_url('uinepg/doLogin');?>">
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button class="btn btn-info btn-o bg-dark text-white" type="submit" >Ingresar</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center">
                                    <div class="small "><a class="text-epg font-weight-bold" href="<?=base_url('registro');?>">No tienes cuenta? Regístrate, como Estudiante!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
