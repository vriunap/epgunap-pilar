  ...
  <div class="card card-timeline mb-4" id='contentPytoKind'>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-12">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-1 bg-primary">
            <h6 class="m-0 font-weight-bold text-white">Busqueda Docente - PILAR EPG</h6>
          </div>
          <div class="card-body p-2">
            <center>

              <form id="frmCodDoc"name='frmCodDoc' method="POST">
                <div class="form-row">

                  <div class="col-md-7">
                    <div class="form-group">
                      <label class="small mb-1" for="iptBusq">DNI / Código Docente</label>
                      <input class="form-control py-2" id="iptBusq" name="iptBusq" type="text" placeholder="Código/DNI/Apellido"  required="" autofocus/>
                    </div>
                  </div>
                  <div class="col-md-5">
                    <div class="form-group">
                      <label class="small mb-1" for="inputLastName"> </label>
                      <button  name="btn-search" id ="btn-search" type='submit' onclick="sendForm('rsltSearchDoc','operacion/1031',frmCodDoc); return false;" class="btn btn-info btn-block btn-xs bg-epg" >Buscar <i class="fa fa-arrow-right"></i></button>
                    </div>
                  </div>
                </div>
              </form>
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-1 bg-primary">
            <h6 class="m-0 font-weight-bold text-white">Listado Docente  - PILAR EPG</h6>
          </div>
          <div class="card-body p-2">

            <center>

              <form id="frmCodDoc2"name='frmCodDoc2' method="POST">
                <div class="form-row">

                  <div class="col-md-7">
                    <div class="form-group">
                      <label class="small mb-1" for="iptCod">Seleccione un Programa de Posgrado</label>
                      
                      <select name="iptBusq" id="iptBusq" class="form-control">
                    <option disabled value="" selected >Selecciona un programa.</option>
                      <?php 

                      $sub=$this->dbRepo->getSnapView('dicProgramas');
                      foreach ($sub->result() as $row) {
                        $tipo=($row->Tipo==1?"M":"D");
                        echo "<option value='$row->Id'>$tipo::$row->Nombre</option>";
                      }
                       ?>
                     </select>
                    </div>
                  ...
                  <div class="col-md-5">
                    <div class="form-group">
                      <label class="small mb-1" for="inputLastName"> </label>
                      <button  name="btn-search" id ="btn-search" type='submit' onclick="sendForm('rsltSearchDoc','operacion/1032',frmCodDoc2); return false;" class="btn btn-info btn-block btn-xs bg-epg" >Buscar <i class="fa fa-arrow-right"></i></button>
                    </div>
                  </div>
                </div>
              </form>
      ...
      <div class="col-lg-8 mb-12" >
        <div class="card shadow mb-4">
        <div class="card-header py-1 bg-primary">
            <h6 class="m-0 font-weight-bold text-white">Área Docente</h6>
          </div>
          <div class="card-body p-5" id ='rsltSearchDoc'>
            Seleccione un filtro de la derecha.
          </div>
        </div>
      </div>
