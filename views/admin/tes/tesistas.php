  ...
  <div class="card card-timeline mb-4" id='contentPytoKind'>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-12">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-1 bg-success">
            <h6 class="m-0 font-weight-bold text-white">Busqueda Tesista</h6>
          </div>
          <div class="card-body p-2">
            <center>

              <form id="frmCodTes"name='frmCodTes' method="POST">
                <div class="form-row">

                  <div class="col-md-7">
                    <div class="form-group">
                      <label class="small mb-1" for="iptBusq">DNI / Código Tesista / Apellidos</label>
                  ...
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <button  name="btn-search" id ="btn-search" type='submit' onclick="sendForm('rsltSearchDoc','operacion/1029',frmCodTes); return false;" class="btn btn-info btn-block btn-xs bg-epg" >Buscar <i class="fa fa-arrow-right"></i></button>
                    </div>
                  </div>
                </div>
              </form>
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-1 bg-success">
            <h6 class="m-0 font-weight-bold text-white">Listado Tesistas  - PILAR EPG</h6>
          </div>
          <div class="card-body p-2">

            <center>

              <form id="frmProgTes"name='frmProgTes' method="POST">
                <div class="form-row">
                  ...
                  <div class="col-md-5">
                    <div class="form-group">
                      <label class="small mb-1" for="inputLastName"> </label>
                      <button  name="btn-search" id ="btn-search" type='submit' onclick="sendForm('rsltSearchDoc','operacion/1030',frmProgTes); return false;" class="btn btn-info btn-block btn-xs bg-epg" >Buscar <i class="fa fa-arrow-right"></i></button>
                    </div>
                  </div>
                </div>
              </form>
      ...
      <div class="col-lg-8 mb-12" >
        <div class="card shadow mb-4">
        <div class="card-header py-1 bg-success">
            <h6 class="m-0 font-weight-bold text-white">Área Tesita</h6>
          </div>
