...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-dark  sidebar sidebar-dark accordion  bg-blue" id="accordionSidebar">
      <br>
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=base_url('uinepg/');?>">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?=base_url('uinepg/');?>">
      ...
      <div class="sidebar-heading">
        PANEL
         ...
         <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="javascript:void(0)" onclick="loadForm('ctntFlow','viewUnidades');" >
       ...
       <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="javascript:void(0)" onclick="loadForm('ctntFlow','viewTesistas');" >
          <i class="fas fa-fw fa-table"></i> 
          <span>Tesistas</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="javascript:void(0)" onclick="loadForm('ctntFlow','viewProyectos');" >
          <i class="fas fa-fw fa-table"></i>
          <span>Trabajos Presentados </span>
        </a>
      </li>

      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="javascript:void(0)" onclick="loadForm('ctntFlow','viewDefensas');" >
          <i class="fas fa-fw fa-table"></i>
      ...
      <div class="sidebar-heading">
        COMPLEMENTOS
                    ...
                    <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="javascript:void(0)" onclick="loadForm('ctntFlow','viewLineas');" >
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="javascript:void(0)" onclick="loadForm('ctntFlow','viewLog');"  id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php 
                      $countp=$this->dbPilar->getSnapView('tesTramites',"Tipo=1")->num_rows();
                       ?>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php 
                      $countp=$this->dbPilar->getSnapView('tesTramites',"Tipo=2")->num_rows();
                       ?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$countp;?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php 
                      $countp=$this->dbPilar->getSnapView('tesTramites',"Tipo=0")->num_rows();
                       ?>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$countp;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Registro de Actividades</div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?=base_url("uinepg/logout");?>">Salir </a>
        </div>
      </div>
    </div>
  </div>
